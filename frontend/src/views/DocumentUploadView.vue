  ...
  <div class="document-page">
    ...
    <div class="page-grid">
      <header class="page-header">
        <div class="title-with-back"><button class="back-button" title="返回工作台" @click="router.push('/workspace')"><ArrowLeft :size="18" /></button><div><h1>文档上传与入库进度</h1><p>把可靠的运维经验，变成下一次排障可检索的答案。</p></div></div>
      </header>
